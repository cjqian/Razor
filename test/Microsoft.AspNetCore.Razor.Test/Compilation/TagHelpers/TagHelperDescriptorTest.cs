...
namespace Microsoft.AspNetCore.Razor.Compilation.TagHelpers
{
    public class TagHelperDescriptorTest
    {
        ...
        public void TagHelperDescriptor_WithPropertyBagElements_CanBeDeserialized()
        {
            ...
            Assert.Empty(descriptor.Attributes);
            Assert.Empty(descriptor.RequiredAttributes);
            Assert.Equal(expectedDescriptor.PropertyBag.Keys, descriptor.PropertyBag.Keys);
            Assert.Equal(expectedDescriptor.PropertyBag.Values, descriptor.PropertyBag.Values);
        }
    }
}
